...
//adding collections and documents into the firestore db from the shop_data.js file
...
//getting the catergories and documents into our application. fetching them from the db.
